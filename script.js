document.addEventListener('DOMContentLoaded', function() {
    ...
    async function getServerStatus() {
        ...
        const jeResponse = await fetch('https://api.mcsrvstat.us/2/mnramc.f5.si:25565');
        const jeData = await jeResponse.json();

        // Bedrock Edition用のAPI呼び出し
        const beResponse = await fetch('https://api.mcsrvstat.us/bedrock/2/mnramc.f5.si:19132');
